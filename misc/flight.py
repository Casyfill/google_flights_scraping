...
def recordFlight(From, To, departure, Return, maxStops=1 ):
	...
	def parseCard (f):
		...
		return { 'link':link, 'trip':flightInDetails(link), 'cost':cost, 'type':Type, 'start':start, 'end':end, 'company':company,'FlightTime':fTime, 'airports':airports, 'stops':stops}
